                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="categories_top_sect">
                                ...
                                <div class="Create_new_category">
                                    <form method="POST" action="{{route('admin.new.verbs.create.category', [request()->segment(2), $category])}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-2">
                                ...
                                <div class="categories_box">
                                    @foreach($categories as $cat)
                                        <div class="categ_item">
                                            <a href="{{ isset($category) ? route('admin.new.verbs.add.item', [request()->segment(2), $category->id, $cat->id]) 
                                              : route('admin.new.verbs.index', [request()->segment(2), $cat->id]) }}">
                                                <img src="{{asset('uploads/categories/verbs/'.request()->segment(2).'/'.$cat->image )}}">
                                                <h2>{{$cat->name}}</h2>
                                            </a>
                                        </div>
                                    @endforeach
