                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="categories_top_sect">
                                ...
                                <div class="Create_new_category">
                                    <form method="POST" action="{{route('admin.new.stories.create.category', [request()->segment(3), $category])}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-2">
                                ...
                                <div class="categories_box">
                                    @foreach($categories as $cat)
                                        <div class="categ_item">
                                            ...
                                            <a href="{{ isset($category) ? route('admin.new.stories.add.item', [request()->segment(3), $category->id, $cat->id])
                                              : route('admin.new.stories.index', [request()->segment(3), $cat->id]) }}">
                                                <img src="{{asset('uploads/categories/stories/'.request()->segment(3).'/'.$cat->image )}}">
                                                <h2>{{$cat->name}}</h2>
                                            </a>
                                        </div>
                                    @endforeach
