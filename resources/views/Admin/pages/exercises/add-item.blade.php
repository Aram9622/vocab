                                           ...
                                           <div class="Vocabulary_table table-responsive">
                                               <table class="table table-bordered">
                                                   ...
                                                   <tr>
                                                           ...
                                                           <div class="audio_player_div">
                                                               <div class="audio_icon">
                                                                   <audio controls style="max-width: 100%;">
                                                                       <source src="{{ asset('uploads/audio/') }}" type="audio/ogg">
                                                                       <source src="{{ asset('uploads/audio/') }}" type="audio/mpeg">
                                                       ...
                                                       <td>
                                                           <div class="edit__div">
                                                               <button class="edit__btn"><img src="{{ asset('images/edit.svg') }}">
                                                               </button>
                                                               <button class="delete__btn"><img
                                                                       src="{{ asset('images/delete.svg') }}"></button>
                                                           </div>
                                                       </td>
                                                   </tr>
                                                   </tbody>
